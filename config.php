...
// ─── Local Override (load BEFORE session so overrides apply in time) ─────────────────
// config.local.php can override dbHost, dbName, dbUser, dbPassword,
// baseUrl, sessionCookieSecure etc. before session_start() is called.
...
if (session_status() === PHP_SESSION_NONE) {
    ...
    // Derive cookie_path dynamically from baseUrl so it works on any install path
